    ...
    <AppShell>
      ...
      <section className="pt-16 pb-20 animate-slide-up">
        ...
        <p className="font-sans text-base text-archive-subtle max-w-lg leading-relaxed mb-10">
          A curated archive of free programming books, courses, tutorials, and
          documentation — in English and Chinese. Search-first, no noise.
        </p>
      ...
      <section className="pb-16 grid md:grid-cols-3 gap-4 animate-fade-in">
        ...
        />
        <FeatureCard
          title="Bilingual archive"
          description="Resources in English and Chinese, filtered to quality open content."
        />
        <FeatureCard
          title="Personal library"
          description="Bookmark resources and track reading progress with your account."
        />
      </section>
    </AppShell>
  );
